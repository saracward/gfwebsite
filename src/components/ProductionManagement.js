    ...
    <div className="serviceContainer">
      <div className="border">
        ...
        <p className="prowords">
          ...
          your vision in a variety of ways. We can do as much or as little as
          you need. As little as providing day-of staff. As much as full-scale
          management & support with both pre-production and on-site execution.
          <br />
          <br />
      ...
      <img
        ...
        alt="Screen-Shot-2021-05-06-at-2-28-12-PM"
        border="0"
      ></img>
      <hr />
    </div>
